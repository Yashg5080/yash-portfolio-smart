...
import { FaJava, FaPython, FaDatabase, FaMicrochip, FaRobot, FaTools } from 'react-icons/fa';
import { SiGraphql, SiJest } from 'react-icons/si';
...
const skills = [
  ...
  { icon: <FaRobot />, name: "Playwright" },
  { icon: <FaMicrochip />, name: "Microservices" },
  { icon: <FaDatabase />, name: "Data Structures" },
  { icon: <GitCommit />, name: "SVN" },
  { icon: <Terminal />, name: "VS Code" },
  { icon: <FaTools />, name: "IntelliJ" },
  { icon: <FaTools />, name: "PyCharm" },
];
